...
typedef struct Slider {
    ...
    bool handle_hovered;
    bool handle_held;
    int diff; // The length of each section of the slider
} Slider;
...
extern Slider* slider_create(float, float, float, float, float, float, float, float, int, const char*, const char*);
